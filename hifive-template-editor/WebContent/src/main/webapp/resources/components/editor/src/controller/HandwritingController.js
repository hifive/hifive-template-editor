...
$(function() {
	 ...
	 *
	 * @name hifive.templateEditor.controller.HandwritingController
	 * @namespace
	 */
	var handwritingController = {
		 ...
		 * コントローラ名
		 *
		 * @memberOf hifive.templateEditor.controller.HandwritingController
		 */
		__name: 'hifive.templateEditor.controller.HandwritingController',
